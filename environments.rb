...
class App < Sinatra::Base
    ...
    get "/result/?" do
        ...
        matched_categories = [
            {id: "I301010", value: "資訊軟體服務業", translated: "", original: {
                service: '沒有限制。',
                consumer: '沒有限制。',
...
iii.在臺灣無商業據點的大陸企業所僱用的人員得依下列條件進入臺灣及停留:
  ...
  的身分，在臺灣廣泛執業的資格。 每次停留的期間不得超過三個月或契約 期間，以較短者為準。此類進入許可的有 效期間自核發的翌日起算為三個月至三 年。符合條件者可在許可有效期間內多次 進入臺灣。
    "
            ...
            # Mockup for ID > 54
            {id: "I301011", value: "資訊軟體服務業2", translated: "", original: {
                specific_commitments: "積極審慎修正有關大陸保險業在臺灣設立代表處及參股評等之規定。"
            }},

            # Mockup for ID == 24
            {id: "I301012", value: "資訊軟體服務業3", translated: "", original: {
    service: "除與「其他承諾」有關者外，不予承諾。",
    consumer: "沒有限制。",
    business: "除與「其他承諾」有關者外，不予承諾。",
    person: "除與「其他承諾」有關者外，不予承諾。",
    other: "根據大陸有關規 定設立的製片單 位所拍攝、符合臺 灣相關規定所定 義之大陸電影 片，經臺灣主管機 關審查通過後，每 年以 15 部為限， 可在臺灣商業發 行映演，並應符合 大陸電影片進入 臺灣發行映演之 相關規定。"
                }}
        ]
